...
function LiveBookingCard() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-sm">
      <div className="absolute -right-4 top-8 h-full w-full rotate-6 rounded-3xl border border-border bg-muted/70" />
      ...
      >
        ...
        <div className="my-5 flex items-center gap-3 border-y border-border py-4">
          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-(image:--gradient-brand) text-sm font-bold text-primary-foreground">
            RK
          </div>
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-[1.1fr_1fr] lg:px-8">
        <div>
          ...
          <p className="mt-6 max-w-lg text-lg text-muted-foreground">
            Browse verified plumbers, electricians, and cleaners near you. Book
            a slot, pay securely, and track every step of the job until it's
            done.
          </p>
